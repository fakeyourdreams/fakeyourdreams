...
def get_temp_frames_pattern(target_path : str, temp_frame_prefix : str) -> str:
	...
	return os.path.join(temp_directory_path, temp_frame_prefix + '.' + fakeyourdreams.globals.temp_frame_format)
...
def get_temp_directory_path(target_path : str) -> str:
	...
	temp_directory_path = os.path.join(tempfile.gettempdir(), 'fakeyourdreams')
...
def clear_temp(target_path : str) -> None:
	...
	if not fakeyourdreams.globals.keep_temp and is_directory(temp_directory_path):
