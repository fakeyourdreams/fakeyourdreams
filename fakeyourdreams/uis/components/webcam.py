...
from fakeyourdreams.audio import create_empty_audio_frame
from fakeyourdreams.common_helper import is_windows
from fakeyourdreams.content_analyser import analyse_stream
from fakeyourdreams.filesystem import filter_image_paths
from fakeyourdreams.typing import VisionFrame, Face, Fps
from fakeyourdreams.face_analyser import get_average_face
from fakeyourdreams.processors.frame.core import get_frame_processors_modules, load_frame_processor_module
from fakeyourdreams.ffmpeg import open_ffmpeg
from fakeyourdreams.vision import normalize_frame_color, read_static_images, unpack_resolution
from fakeyourdreams.uis.typing import StreamMode, WebcamMode
from fakeyourdreams.uis.core import get_ui_component, get_ui_components
...
def start(webcam_mode : WebcamMode, webcam_resolution : str, webcam_fps : Fps) -> Generator[VisionFrame, None, None]:
	fakeyourdreams.globals.face_selector_mode = 'one'
	fakeyourdreams.globals.face_analyser_order = 'large-small'
...
def multi_process_capture(source_face : Face, webcam_capture : cv2.VideoCapture, webcam_fps : Fps) -> Generator[VisionFrame, None, None]:
	with tqdm(desc = wording.get('processing'), unit = 'frame', ascii = ' =', disable = fakeyourdreams.globals.log_level in [ 'warn', 'error' ]) as progress:
		with ThreadPoolExecutor(max_workers = fakeyourdreams.globals.execution_thread_count) as executor:
			futures = []
