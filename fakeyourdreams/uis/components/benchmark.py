...
from fakeyourdreams import process_manager, wording
from fakeyourdreams.face_store import clear_static_faces
from fakeyourdreams.processors.frame.core import get_frame_processors_modules
from fakeyourdreams.vision import count_video_frame_total, detect_video_resolution, detect_video_fps, pack_resolution
from fakeyourdreams.core import conditional_process
from fakeyourdreams.memory import limit_system_memory
from fakeyourdreams.filesystem import clear_temp
...
def start(benchmark_runs : List[str], benchmark_cycles : int) -> Generator[List[Any], None, None]:
	fakeyourdreams.globals.source_paths = [ '.assets/examples/source.jpg', '.assets/examples/source.mp3' ]
	fakeyourdreams.globals.output_path = tempfile.gettempdir()
	fakeyourdreams.globals.face_landmarker_score = 0
	fakeyourdreams.globals.temp_frame_format = 'bmp'
	fakeyourdreams.globals.output_video_preset = 'ultrafast'
	benchmark_results = []
	...
	if target_paths:
		...
		for target_path in target_paths:
			fakeyourdreams.globals.target_path = target_path
...
def benchmark(benchmark_cycles : int) -> List[Any]:
	...
	return\
	[
		fakeyourdreams.globals.target_path,
		benchmark_cycles,
		average_run,
		fastest_run,
		slowest_run,
